    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className="mx-4 rounded-2xl overflow-hidden h-[118px] relative shrink-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#080e24]/70 via-transparent to-transparent" />
        </div>
        ...
        <div className="px-4 pb-5 grid grid-cols-2 gap-2 shrink-0">
          ...
          <a
            ...
            className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-400 hover:to-emerald-400 text-white py-2.5 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-[0_0_15px_rgba(16,185,129,0.25)]"
          >
