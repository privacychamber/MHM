...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center pt-24 pb-12 z-10">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center z-20 order-2 lg:order-1">
              ...
              >
                ...
                <div className="relative w-full max-w-md">
                  <div className={`relative flex items-center bg-navy-900/50 backdrop-blur-xl border ${showSuggestions ? 'border-yellow-400/50' : 'border-white/20'} rounded-2xl p-2 transition-all duration-300 shadow-[0_0_30px_rgba(0,0,0,0.5)] group hover:border-yellow-400/50 hover:shadow-[0_0_20px_rgba(250,204,21,0.15)]`}>
                    ...
                    />
                    <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 hover:from-yellow-300 hover:to-yellow-500 text-navy-900 px-6 py-3 rounded-xl font-bold transition-all shadow-lg transform active:scale-95">
                      Explore
                    </button>
                  </div>
                    ...
                    {showSuggestions && searchQuery && (
                      ...
                      >
                        {filteredDestinations.length > 0 ? (
                          ...
                          <div className="p-4 text-slate-400 text-sm">No destinations found. Try "Japan" or "Dubai".</div>
                        )}
                      </motion.div>
                    )}
                  </AnimatePresence>
      ...
      <a 
        href="#"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.4)] text-white hover:scale-110 transition-transform md:hidden"
      >
